...
static int init_perso(obj_t *perso)
{
    ...
    perso->char_down = (sfIntRect){0, perso->nb_perso * 120, 16, 16};
    perso->char_up = (sfIntRect){0, perso->nb_perso * 120 + 61, 16, 16};
    perso->char_left = (sfIntRect){0, perso->nb_perso * 120 + 30, 16, 16};
    perso->char_right = (sfIntRect){0, perso->nb_perso * 120 + 90, 16, 16};
    perso->move.y = 3;
    perso->move.x = 3;
